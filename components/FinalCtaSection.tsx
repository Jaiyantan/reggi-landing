  ...
  return (
    ...
    >
      <style>{`
        ...
        .cta-anim-up { opacity: 0; transform: translateY(24px); }
        
        .cta-section.is-visible .cta-anim-up {
      ...
      <div className="max-w-[1200px] mx-auto px-[20px] md:px-[40px] relative z-10">
        <div className="flex flex-col md:grid md:grid-cols-12 gap-y-[32px] md:gap-x-[48px] lg:gap-x-[80px] items-center">
          ...
          <div className="w-full md:col-span-5 z-10 flex flex-col items-center md:items-start text-center md:text-left">
            ...
            <div className="cta-anim-up w-full relative flex justify-center md:hidden mt-[24px] mb-[32px]" style={{ animationDelay: '150ms' }}>
            ...
            <div className="cta-anim-up w-full flex flex-col sm:flex-row items-center justify-center md:justify-start gap-[16px] md:mb-[48px]" style={{ animationDelay: '250ms' }}>
              <button 
            ...
            <div className="cta-anim-up w-full max-w-full flex flex-row items-center justify-center md:justify-start gap-[8px] lg:gap-[16px] pt-[24px] mt-[24px] md:mt-0 border-t border-black/5 whitespace-nowrap overflow-x-auto md:overflow-visible no-scrollbar" style={{ animationDelay: '300ms' }}>
          ...
          <div className="cta-anim-up hidden md:flex w-full md:col-span-7 relative justify-end md:-mt-[20px] lg:-mt-[40px]" style={{ animationDelay: '150ms' }}>
