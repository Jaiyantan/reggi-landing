...
export const metadata: Metadata = {
  title: 'Terms of Service – REGGI',
  description: 'Terms of Service for REGGI Jujube Superfood products.',
};
      ...
      <div className="max-w-[760px] mx-auto">
        ...
        <div className="bg-white rounded-[20px] p-[40px] shadow-card">
          <p className="text-textMid text-[16px] leading-[1.8]">
            Content coming soon. We are currently drafting our Terms of Service. Please check back later or contact us at{' '}
